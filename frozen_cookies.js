// Reroll wouldn't work. Use Pastebin bookmarklet(for v2021): javascript:(function() { Game.LoadMod('https://pastebin.com/raw/uxbskbme'); }());
// Global Variables
...
var baseUrl = scriptElement !== null ?
    ...
    'https://MakingBaconPancakes.github.io/FrozenCookies/';
var FrozenCookies = {
    'baseUrl': baseUrl,
    'branch': '',
    'version': '1.7.0.2022'
